...
AUTH0_CLIENT_SECRET = os.environ.get("AUTH0_CLIENT_SECRET", "Yd9J7Ombl8XAyjcPsfckbby5e3MotI-mQ2WnR2pVJ-fHgVtoltQVE0gQW_F0dIYq")
MCP_SERVER_URL      = os.environ.get("MCP_SERVER_URL",      "https://mistralai.devailab.work")
JWKS_URL            = f"https://{AUTH0_DOMAIN}/.well-known/jwks.json"
ISSUER              = f"https://{AUTH0_DOMAIN}/"

# ---------------------------------------------------------------------------
# ✅ CHANGED: Claude's OAuth callback URL (was Mistral's callback URL)
# ---------------------------------------------------------------------------
...
async def oauth_metadata(request: Request) -> JSONResponse:
    return JSONResponse({
        ...
        # ✅ Authorization endpoint — no audience param needed for Claude (DCR handles it)
...
async def dynamic_client_registration(request: Request) -> JSONResponse:
    ...
    # ✅ CHANGED: Use Claude's callback URL instead of Mistral's
    ...
    # ✅ ADDED: Set client name to "Claude" so Auth0 recognises it
